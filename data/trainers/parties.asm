...
LassGroup:
	...
	db 25, CHARMANDER, SCRATCH, SMOKESCREEN, EMBER, RAGE
	db 23, SENTRET,    TACKLE, DEFENSE_CURL, QUICK_ATTACK, FURY_SWIPES
	db 24, MARILL,     TACKLE, DEFENSE_CURL, ROLLOUT, WATER_GUN
	db -1 ; end

	; LASS (19)
	db "ISABEL@", TRAINERTYPE_MOVES
	db 25, SQUIRTLE,   BITE, WITHDRAW, WATER_GUN, RAPID_SPIN
	db 23, PIDGEY,     TACKLE, SAND_ATTACK, GUST, QUICK_ATTACK
	db 24, PIKACHU,    THUNDERSHOCK, DOUBLE_TEAM, THUNDER_WAVE, QUICK_ATTACK
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 25, PICHU,      THUNDERSHOCK, CHARM, THUNDER_WAVE, SWEET_KISS
	db 26, PIKACHU,    THUNDERSHOCK, DOUBLE_TEAM, THUNDER_WAVE, QUICK_ATTACK
	db 27, RAICHU,     THUNDERBOLT,  DOUBLE_TEAM, THUNDER_WAVE, SLAM
	db -1 ; end
...
TeacherGroup:
	...
	; TEACHER (4)
	db "KATHRYN@", TRAINERTYPE_MOVES
	db 26, BELLOSSOM,  PETAL_DANCE, SLEEP_POWDER, MEGA_DRAIN, POISONPOWDER
	db 25, PIDGEOTTO,  GUST, SAND_ATTACK, QUICK_ATTACK, WHIRLWIND
	db 24, FURRET,     FORESIGHT, DEFENSE_CURL, QUICK_ATTACK, SLAM
	db -1 ; end
